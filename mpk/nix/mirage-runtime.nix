{
  ...
  mirageZ3Root = "${mirageZ3}/${python3.sitePackages}/z3";
  mirageZ3IncludeDir = "${mirageZ3Root}/include";
  mirageZ3Lib = "${mirageZ3Root}/lib/libz3.so";
...
in
  stdenv.mkDerivation {
    ...
    cmakeFlags = [
      ...
      "-DZ3_CXX_INCLUDE_DIRS=${mirageZ3IncludeDir}"
      "-DZ3_LIBRARIES=${mirageZ3Lib}"
